        ...
        <section className={styles.mainwrapper} id="section2" data-scroll-to="section2">
            <div className={styles.subwrapper}>
                ...
                <div className={styles.body_wrapper} style={{zIndex:1}}>
                    ...
                    Beno is a meme coin like no other, driven by the cool and charismatic Shiba Inu spirit with an extra dash of swag! With a lovable yet mischievous Shiba dog at its core, Beno combines fun, community, and crypto innovation into one furry, unstoppable package. Whether you're here for the memes, the hype, or just to see where this wild ride takes you, Beno is your ticket to the moon (and maybe some tail wags along the way).Time to join the Beno pack!
